  ...
  <div>
    ...
    <div class="select">
      <span class="sele_shijian">
        <van-cell is-link @click="showPopup('w')" style="margin-top: -0.3rem">选择上课时间</van-cell>
        <van-popup v-model="shows" position="bottom" :overlay="false" :duration="0.001"
          ...
          <div class="option_time">
            ...
            <!-- 选项过滤器 -->
            <van-datetime-picker v-show="picker" v-model="currentTime" type="time" :filter="filter" style="z-index: 111"
              @confirm="confirm" @cancel="cancel" item-height="35" />
          </div>
      ...
      <!-- 选择老师条件 -->
      <span class="sele_shijian">
        <van-cell is-link @click="showPopup('w1')" style="margin-top: -0.3rem" :closeable="true">选择老师条件</van-cell>
        <div>
          <van-popup v-model="showss" position="bottom" :overlay="false" :duration="0.001"
            :style="{ height: '87%', width: '100%' }">
            <!-- 选择老师条件 内容 -->
